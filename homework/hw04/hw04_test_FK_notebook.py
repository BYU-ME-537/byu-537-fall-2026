# %% [markdown]
# # Homework 4
# * Complete the HW04 sections in the cumulative byu_robomanip package.
# * Implement the sections that convert between Euler angles, Axis/Angle,
#   Quaternions, and rotation matrices, all of which represent SO(3).
