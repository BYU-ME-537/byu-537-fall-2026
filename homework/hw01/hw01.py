...
# * Make sure to have set up your Python environment and installed this project with
#   `python -m pip install -e .` from the repository root (see "pyproject.toml" there and
...
# %%
# this cell will fail if you haven't correctly installed the necessary python libraries
import numpy as np
import time
